...
struct BoxROITest :  public ::testing::Test
{
    ...
    void attributesTests(){
        ...
        vector<string> attrnames = {
            ...
            "indices","indicesOut", "edgeIndices", "triangleIndices", "tetrahedronIndices", "hexahedronIndices",
            "quadIndices",
            "pointsInROI","pointsOutROI", "edgesInROI", "trianglesInROI", "tetrahedraInROI", "hexahedraInROI", "quadInROI",
            "nbIndices",
